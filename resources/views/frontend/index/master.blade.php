...
<html lang="en">
   ...
   <body>
      ...
      <div class="overlay"></div>
        @include('frontend.index.layouts.header_home')
        @include('frontend.index.layouts.banner')
      </div>
      @include('frontend.index.layouts.ads')

      @yield('content')

      @include('frontend.index.layouts.member')
