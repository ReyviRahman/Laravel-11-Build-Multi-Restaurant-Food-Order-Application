            ...
            <div class="row">
              ...
              <div class="col-xl-4 col-md-6">
                <div class="form-group mb-3">
                  ...
                  <input class="form-control" type="number" name="discount_price" min="0">
                </div>
              </div>
              ...
              <div class="col-xl-4 col-md-6 d-flex align-items-center gap-3 mb-3">
                <div class="form-check">
                  <input class="form-check-input" name="best_seller" type="checkbox" value="1" id="bestSeller">
                  <label class="form-check-label" for="bestSeller">Best Seller</label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" name="most_populer" type="checkbox" value="1" id="mostPopuler">
